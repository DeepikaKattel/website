                        ...
                        <div class="col-md-3" >
                            <div class="row justify-content-center" >
                             <div class="col-md-5 col-5 d-flex justify-content-end">
                                 <div class="infoBox"><i class="fas fa-map"></i></div>
                             </div>
                         ...
                         <div class="col-md-3">
                            <div class="row justify-content-center" >
                             <div class="col-md-5 col-5 d-flex justify-content-end">
                                 <div class="infoBox"><i class="fas fa-phone"></i></div>
                             </div>
                             <div class="col-md-7 col-7" >
                         ...
                         <div class="col-md-3" >
                            <div class="row justify-content-center" >
                             <div class="col-md-5 col-5 d-flex justify-content-end">
                                 <div class="infoBox"><i class="fas fa-envelope"></i></div>
                             </div>
                             <div class="col-md-7 col-7" >
                         ...
                         <div class="col-md-3" >
                            <div class="row justify-content-center" >
                             <div class="col-md-5 col-5 d-flex justify-content-end">
                                 <div class="infoBox"><i class="fas fa-clock"></i></div>
                             </div>
                             <div class="col-md-7 col-7" >
